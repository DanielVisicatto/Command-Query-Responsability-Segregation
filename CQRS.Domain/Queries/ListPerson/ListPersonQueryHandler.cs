...
namespace CQRS.Domain.Queries.ListPerson
{
    public class ListPersonQueryHandler : BaseHandler
    {
        ...
        public ListPersonQueryHandler(IPersonRepository repository, IMapper mapper)
        {
        ...
        {
            var people = await _repository.GetAsync(person => (query.Name == null || person.Name.Contains(query.Name.ToUpper()))
